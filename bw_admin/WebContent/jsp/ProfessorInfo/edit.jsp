...
<rapid:override name="head">
	<title>专家详细信息编辑_后台管理</title>
</rapid:override>

<rapid:override name="content">
	<form action="${ctx}//ProfessorInfo/update.do" method="post">
		<input id="submitButton" name="submitButton" type="submit" value="提交" />
		<input type="button" value="返回列表" onclick="window.location='${ctx}//ProfessorInfo/list.do'"/>
	...
	<script>
		...
		$(function() {
			var picture = '${professorInfo.logoImage}';
			if (picture == '') {
				addImg();
			} else {
				addImg();
				$("#img_form").show();
				$("#img_form").attr("src",
						"/bw_admin/ProfessorInfo/showImg.do?picId=" + picture);
				$("#file_form").hide();
				$("#button_form").hide();
				$("#button_cancel").show();
			}
		...
		function addImg() {
			...
			$("#logoImage")
					.after(
							"<div id='div_img'><form action='/bw_admin/ProfessorInfo/addImg.do' method='post' enctype='multipart/form-data' id='form_img'>"
					...
					.ajaxSubmit(
							{
								...
								success : function(data, stat) {
									...
									$("#img_form").attr(
											"src",
											"/bw_admin//ProfessorInfo/showImg.do?picId="
													+ data);
