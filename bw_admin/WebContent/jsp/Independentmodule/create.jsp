...
<center>
<h2>信息发布平台</h2>
	<form action="${ctx}//Independentmodule/save.do" method="post" name="form2" id="form2">
			标题:<textarea name="plattsTitle" id="plattsTitle"  rows="2" cols="60"></textarea><br>
			内容:<textarea name="plattsDetail" id="plattsDetail" ></textarea><br>
			来源:<textarea name="plattsSign" id="plattsSign"  ></textarea><br>
			关键字:<textarea name="plattsStatus" id="plattsStatus" style="width:200px"></textarea>
			<br>
